...
impl FromQVariant for i64 {
    fn from_qvariant(var: *const QVariant) -> Option<i64> {
        unsafe {
            if ffi::rsqml_variant_get_type(var) == QrsVariantType::Int64 {
                let mut x: i64 = 0;
                ffi::rsqml_variant_get_int64(var, &mut x);
                Some(x)
            } else {
                None
            }
...
impl FromQVariant for bool {
    fn from_qvariant(var: *const QVariant) -> Option<bool> {
        unsafe {
            if ffi::rsqml_variant_get_type(var) == QrsVariantType::Bool {
                let mut x: bool = false;
                ffi::rsqml_variant_get_bool(var, &mut x);
                Some(x)
            } else {
                None
            }
...
impl FromQVariant for String {
    fn from_qvariant(var: *const QVariant) -> Option<String> {
        unsafe {
            if ffi::rsqml_variant_get_type(var) == QrsVariantType::String {
                let mut len: c_uint = 0;
                ffi::rsqml_variant_get_string_length(var, &mut len);

                let mut data: Vec<u8> = Vec::with_capacity(len as usize);
                ffi::rsqml_variant_get_string_data(var, data.as_mut_ptr() as *mut c_char);
...
impl FromQVariant for Variant {
    fn from_qvariant(var: *const QVariant) -> Option<Variant> {
        ...
        unsafe {
            match ffi::rsqml_variant_get_type(var) {
                Int64 =>
...
impl ToQVariant for () {
    fn to_qvariant(&self, var: *mut QVariant) {
        unsafe {
            ffi::rsqml_variant_set_invalid(var);
        }
    }
}
...
impl ToQVariant for i64 {
    fn to_qvariant(&self, var: *mut QVariant) {
        unsafe {
            ffi::rsqml_variant_set_int64(var, *self);
        }
    }
}
...
impl ToQVariant for bool {
    fn to_qvariant(&self, var: *mut QVariant) {
        unsafe {
            ffi::rsqml_variant_set_bool(var, *self);
        }
    }
}
...
impl ToQVariant for str {
    fn to_qvariant(&self, var: *mut QVariant) {
        unsafe {
            ffi::rsqml_variant_set_string(var, self.len() as c_uint,
